...
<body class="font-primary-font ">
     <main class="flex h-screen overflow-hidden">
          ...
          <section class="relative z-0 flex-1 bg-whiten-bg-color overflow-auto">
               <div
                    class="absolute z-[-1] top-0 left-0 right-0 w-full h-96 bg-gradient-to-r from-primary-color to-secondary-color">
               </div>
                    ...
                    <div class="relative flex items-center justify-between  ">
                         ...
                         <div onclick="showDropDownMenu();" class="relative select-none">
                              ...
                              <div id="drop-down-menu"
                                   class="hidden shadow-custom-shadow-1 absolute top-[130%] right-0 min-w-[12rem] py-2 rounded-md bg-white">
                                   <p class="px-4 py-2 text-xs font-semibold uppercase">Chào mừng!</p>
                                   <ul class="flex flex-col">
                                        <li><a class="flex items-center p-4 text-[.9rem] font-medium hover:bg-slate-100"
                                                  href="" target="_self"><i
                                                       class="bx text-[1.2rem] pr-2 bxs-user-account"></i> Hồ sơ của
                                                  tôi</a></li>
                                        <li><a class="flex items-center p-4 text-[.9rem] font-medium hover:bg-slate-100"
                                                  href="" target="_self"><i
                                                       class="bx text-[1.2rem] pr-2 bx-log-out"></i>Đăng xuất</a></li>
                                   </ul>
                              </div>
                         </div>
                    </div>
